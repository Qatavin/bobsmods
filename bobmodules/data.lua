...
bobmods.modules.QualityPerLevel = settings.startup["bobmods-modules-perlevel-bonus-quality"]
...
bobmods.modules.QualityBonus = settings.startup["bobmods-modules-start-bonus-quality"]
