...
bobmods.modules.QualityPerLevel = settings.startup["bobmods-modules-perlevel-bonus-quality"] and settings.startup["bobmods-modules-perlevel-bonus-quality"].value or 0.01
...
bobmods.modules.QualityBonus = settings.startup["bobmods-modules-start-bonus-quality"] and settings.startup["bobmods-modules-start-bonus-quality"].value or 0.01
